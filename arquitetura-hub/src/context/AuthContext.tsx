...
const MOCK_USERS: Record<string, { password: string; user: User }> = {
  ...
  'wladsonsidney@gmail.com': {
    password: '12345678',
    user: { id: 'mentor-2', email: 'wladsonsidney@gmail.com', full_name: 'Wladson Sidney', role: 'admin' },
  },
  'vitorlvbraga@gmail.com': {
    password: '12345678',
    user: { id: 'member-3', email: 'vitorlvbraga@gmail.com', full_name: 'Vitor Braga', role: 'membro' },
  },
  'rodrigocunhapro@gmail.com': {
    password: '12345678',
    user: { id: 'member-4', email: 'rodrigocunhapro@gmail.com', full_name: 'Rodrigo Cunha', role: 'membro' },
  },
  'wladson@sanchocorporativo.com.br': {
    password: '12345678',
    user: { id: 'mentor-3', email: 'wladson@sanchocorporativo.com.br', full_name: 'Wladson Sidney', role: 'admin' },
  },
}
